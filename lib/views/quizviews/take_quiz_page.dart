...
class _QuizTakingPageState extends State<QuizTakingPage> with SingleTickerProviderStateMixin {
  ...
  void _onPageChanged(int index) {
    // Save current flip state before changing
    final wasFlipped = _flipStates[currentQuestionIndex] ?? false;
